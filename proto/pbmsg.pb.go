...
const (
	...
	MsgId_TASK_STAT_GET                 MsgId = 314
	MsgId_TASK_STAT_GET_REPLY           MsgId = 315
...
type BoardAttr struct {
	...
	// 配置类型
	Type BoardBtnType `protobuf:"varint,1,opt,name=type,proto3,enum=BoardBtnType" json:"type,omitempty"`
	// 配置内容，分区id或通道标识
...
type AlarmIn struct {
	...
	// 触发状态
	TriggerStatus AlarmInStatus `protobuf:"varint,3,opt,name=trigger_status,json=triggerStatus,proto3,enum=AlarmInStatus" json:"trigger_status,omitempty"`
	// 触发方式
	TriggerMethod AlarmInTriggerMethod `protobuf:"varint,4,opt,name=trigger_method,json=triggerMethod,proto3,enum=AlarmInTriggerMethod" json:"trigger_method,omitempty"`
	// 触发任务uuid
...
type IntelligentizeTask struct {
	...
	// 当前智能任务类型
	TaskType TaskType `protobuf:"varint,9,opt,name=task_type,json=taskType,proto3,enum=TaskType" json:"task_type,omitempty"`
}
...
type Task struct {
	...
	// 音源
	Source AudioSource `protobuf:"varint,5,opt,name=source,proto3,enum=AudioSource" json:"source,omitempty"`
	// 音频文件列表
	...
	// 任务重复方式
	Repeat RepeatType `protobuf:"varint,12,opt,name=repeat,proto3,enum=RepeatType" json:"repeat,omitempty"`
	// 一周中的哪几天重复
	...
	// 任务类型
	TaskType TaskType `protobuf:"varint,21,opt,name=task_type,json=taskType,proto3,enum=TaskType" json:"task_type,omitempty"`
	// 代理服务ip
	...
	// 背景音源
	Background AudioSource `protobuf:"varint,32,opt,name=background,proto3,enum=AudioSource" json:"background,omitempty"`
	// 任务持续播放时长
	Duration uint32 `protobuf:"varint,33,opt,name=duration,proto3" json:"duration,omitempty"`
	// 文字显示方式
	TextDisplayStyle TEXT_DISPLAY_STYLE `protobuf:"varint,34,opt,name=text_display_style,json=textDisplayStyle,proto3,enum=TEXT_DISPLAY_STYLE" json:"text_display_style,omitempty"`
	// 文字显示速度
	TextDisplaySpeed TEXT_DISPLAY_SPEED `protobuf:"varint,35,opt,name=text_display_speed,json=textDisplaySpeed,proto3,enum=TEXT_DISPLAY_SPEED" json:"text_display_speed,omitempty"`
	// 文字显示持续时间（分钟）
	...
	// 歌曲播放方式
	SongPlayType SongPlayType `protobuf:"varint,44,opt,name=song_play_type,json=songPlayType,proto3,enum=SongPlayType" json:"song_play_type,omitempty"`
	PaStreamType PaStreamType `protobuf:"varint,45,opt,name=pa_stream_type,json=paStreamType,proto3,enum=PaStreamType" json:"pa_stream_type,omitempty"`
}
...
type TaskStop struct {
	...
	Username string   `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Uuid     string   `protobuf:"bytes,2,opt,name=uuid,proto3" json:"uuid,omitempty"`
	TaskType TaskType `protobuf:"varint,3,opt,name=task_type,json=taskType,proto3,enum=TaskType" json:"task_type,omitempty"`
}
...
type GetLog struct {
	...
	Username string  `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Type     LogType `protobuf:"varint,2,opt,name=type,proto3,enum=LogType" json:"type,omitempty"`
	// 任务的uuid
	TaskUuid string `protobuf:"bytes,3,opt,name=task_uuid,json=taskUuid,proto3" json:"task_uuid,omitempty"`
	// 请求日志条数
...
type FileUpload struct {
	...
	Filetype FileType `protobuf:"varint,7,opt,name=filetype,proto3,enum=FileType" json:"filetype,omitempty"`
}
...
type ChannelAttr struct {
	...
	// 广播流类型 - 调音台通道属性
	PaStreamType PaStreamType `protobuf:"varint,16,opt,name=pa_stream_type,json=paStreamType,proto3,enum=PaStreamType" json:"pa_stream_type,omitempty"`
}
...
type SoundConsoleTaskControl struct {
	...
	Username string                         `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Uuid     string                         `protobuf:"bytes,2,opt,name=uuid,proto3" json:"uuid,omitempty"`
	Command  SoundConsoleTaskControlCommand `protobuf:"varint,3,opt,name=command,proto3,enum=SoundConsoleTaskControlCommand" json:"command,omitempty"`
	// 歌曲名
	...
	VolumeType VolumeType `protobuf:"varint,6,opt,name=volume_type,json=volumeType,proto3,enum=VolumeType" json:"volume_type,omitempty"`
...
type DevicePowerSet struct {
	...
	Username   string      `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Out_1Power DevicePower `protobuf:"varint,2,opt,name=out_1_power,json=out1Power,proto3,enum=DevicePower" json:"out_1_power,omitempty"`
	Out_2Power DevicePower `protobuf:"varint,3,opt,name=out_2_power,json=out2Power,proto3,enum=DevicePower" json:"out_2_power,omitempty"`
	Out_3Power DevicePower `protobuf:"varint,4,opt,name=out_3_power,json=out3Power,proto3,enum=DevicePower" json:"out_3_power,omitempty"`
	Out_4Power DevicePower `protobuf:"varint,5,opt,name=out_4_power,json=out4Power,proto3,enum=DevicePower" json:"out_4_power,omitempty"`
}
...
type DevicePowerGetReply struct {
	...
	Out_1Power DevicePower `protobuf:"varint,3,opt,name=out_1_power,json=out1Power,proto3,enum=DevicePower" json:"out_1_power,omitempty"`
	Out_2Power DevicePower `protobuf:"varint,4,opt,name=out_2_power,json=out2Power,proto3,enum=DevicePower" json:"out_2_power,omitempty"`
	Out_3Power DevicePower `protobuf:"varint,5,opt,name=out_3_power,json=out3Power,proto3,enum=DevicePower" json:"out_3_power,omitempty"`
	Out_4Power DevicePower `protobuf:"varint,6,opt,name=out_4_power,json=out4Power,proto3,enum=DevicePower" json:"out_4_power,omitempty"`
}
...
type TaskSync struct {
	...
	Username string       `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Type     TaskSyncType `protobuf:"varint,2,opt,name=type,proto3,enum=TaskSyncType" json:"type,omitempty"`
	TaskUuid string       `protobuf:"bytes,3,opt,name=task_uuid,json=taskUuid,proto3" json:"task_uuid,omitempty"`
}
...
type TaskSyncStatusGetReply struct {
	...
	Status  TaskSyncStatus `protobuf:"varint,1,opt,name=status,proto3,enum=TaskSyncStatus" json:"status,omitempty"`
...
func (x *TaskStatGet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TaskStatGet) ProtoMessage() {}

func (x *TaskStatGet) ProtoReflect() protoreflect.Message {
	mi := &file_pbmsg_proto_msgTypes[115]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TaskStatGet.ProtoReflect.Descriptor instead.
func (*TaskStatGet) Descriptor() ([]byte, []int) {
	return file_pbmsg_proto_rawDescGZIP(), []int{115}
}

func (x *TaskStatGet) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *TaskStatGetReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TaskStatGetReply) ProtoMessage() {}

func (x *TaskStatGetReply) ProtoReflect() protoreflect.Message {
	mi := &file_pbmsg_proto_msgTypes[116]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TaskStatGetReply.ProtoReflect.Descriptor instead.
func (*TaskStatGetReply) Descriptor() ([]byte, []int) {
	return file_pbmsg_proto_rawDescGZIP(), []int{116}
}

func (x *TaskStatGetReply) GetStatus() Status {
	if x != nil {
		return x.Status
	}
	return Status_SUCCEED
...
type KeyPress struct {
	...
	Id      Key  `protobuf:"varint,1,opt,name=id,proto3,enum=Key" json:"id,omitempty"`
...
type LedBoardControl struct {
	...
	Username string            `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Id       LedBoardControlId `protobuf:"varint,2,opt,name=id,proto3,enum=LedBoardControlId" json:"id,omitempty"`
}
...
type FactoryTest struct {
	...
	Id    FactoryTestId `protobuf:"varint,1,opt,name=id,proto3,enum=FactoryTestId" json:"id,omitempty"`
	Start bool          `protobuf:"varint,2,opt,name=start,proto3" json:"start,omitempty"`
	Text  string        `protobuf:"bytes,3,opt,name=text,proto3" json:"text,omitempty"`
	// 文字显示方式
	TextDisplayStyle TEXT_DISPLAY_STYLE `protobuf:"varint,4,opt,name=text_display_style,json=textDisplayStyle,proto3,enum=TEXT_DISPLAY_STYLE" json:"text_display_style,omitempty"`
	// 文字显示速度
	TextDisplaySpeed TEXT_DISPLAY_SPEED `protobuf:"varint,5,opt,name=text_display_speed,json=textDisplaySpeed,proto3,enum=TEXT_DISPLAY_SPEED" json:"text_display_speed,omitempty"`
	// 文字显示持续时间（分钟）
...
var file_pbmsg_proto_rawDesc = []byte{
	,
	...
	0x0a, 0x0c, 0x44, 0x61, 0x74, 0x65, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x0a, 0x09, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x75, 0x75, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x55, 0x75, 0x69, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x64, 0x12, 0x26, 0x0a, 0x09, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x22, 0x44, 0x0a, 0x0d, 0x54, 0x61,
	0x73, 0x6b, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1f, 0x0a, 0x06, 0x73,
	...
	,
	...
	0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x1a, 0x0a, 0x08,
	0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x75, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x22, 0x32, 0x0a, 0x0f,
	0x54, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	...
	0x22, 0x68, 0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x49, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x12, 0x1a,
	0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x75,
	...
	0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x06, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x22, 0x32, 0x0a, 0x0f, 0x54, 0x61,
	0x73, 0x6b, 0x49, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1f, 0x0a,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x07, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x43,
	0x0a, 0x11, 0x54, 0x61, 0x73, 0x6b, 0x49, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x44, 0x61, 0x74, 0x65,
	...
	0x75, 0x69, 0x64, 0x22, 0x4d, 0x0a, 0x16, 0x54, 0x61, 0x73, 0x6b, 0x49, 0x67, 0x6e, 0x6f, 0x72,
	0x65, 0x44, 0x61, 0x74, 0x65, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1f, 0x0a,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x07, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x55, 0x75, 0x69, 0x64, 0x22, 0x5b, 0x0a, 0x16, 0x54,
	0x61, 0x73, 0x6b, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x27, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x79, 0x6e, 0x63,
	...
	,
	...
	0x52, 0x08, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x6d, 0x0a, 0x11, 0x54, 0x61,
	0x73, 0x6b, 0x41, 0x64, 0x64, 0x4f, 0x75, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12,
	0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x22, 0x28, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x47,
	0x65, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x22, 0x45, 0x0a, 0x0a, 0x4a,
	0x6f, 0x69, 0x6e, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65,
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_pbmsg_proto_goTypes = []any{
	(MsgId)(0),                            // 0: MsgId
	(Status)(0),                           // 1: Status
	(BoardBtnType)(0),                     // 2: BoardBtnType
	(AlarmInStatus)(0),                    // 3: AlarmInStatus
	(AlarmInTriggerMethod)(0),             // 4: AlarmInTriggerMethod
	(ChannelPower)(0),                     // 5: ChannelPower
	(RepeatType)(0),                       // 6: RepeatType
	(AudioSource)(0),                      // 7: AudioSource
	(TaskType)(0),                         // 8: TaskType
	(TEXT_DISPLAY_STYLE)(0),               // 9: TEXT_DISPLAY_STYLE
	(TEXT_DISPLAY_SPEED)(0),               // 10: TEXT_DISPLAY_SPEED
	(SongPlayType)(0),                     // 11: SongPlayType
	(LogType)(0),                          // 12: LogType
	(FileType)(0),                         // 13: FileType
	(PaStreamType)(0),                     // 14: PaStreamType
	(VolumeType)(0),                       // 15: VolumeType
	(SoundConsoleTaskControlCommand)(0),   // 16: SoundConsoleTaskControlCommand
	(DevicePower)(0),                      // 17: DevicePower
	(TaskSyncType)(0),                     // 18: TaskSyncType
	(TaskSyncStatus)(0),                   // 19: TaskSyncStatus
	(Key)(0),                              // 20: Key
	(LedBoardControlId)(0),                // 21: LedBoardControlId
	(FactoryTestId)(0),                    // 22: FactoryTestId
	(*UserLogin)(nil),                     // 23: UserLogin
	(*UserLoginReply)(nil),                // 24: UserLoginReply
	(*DateSet)(nil),                       // 25: DateSet
	(*DateSetReply)(nil),                  // 26: DateSetReply
	(*DateGet)(nil),                       // 27: DateGet
	(*DateGetReply)(nil),                  // 28: DateGetReply
	(*NcsCfg)(nil),                        // 29: NcsCfg
	(*SipCfg)(nil),                        // 30: SipCfg
	(*NetCfg)(nil),                        // 31: NetCfg
	(*NetCfgGet)(nil),                     // 32: NetCfgGet
	(*NetCfgGetReply)(nil),                // 33: NetCfgGetReply
	(*NetCfgSet)(nil),                     // 34: NetCfgSet
	(*NetCfgSetReply)(nil),                // 35: NetCfgSetReply
	(*NcsCfgSet)(nil),                     // 36: NcsCfgSet
	(*NcsCfgSetReply)(nil),                // 37: NcsCfgSetReply
	(*ExtendBoardPack)(nil),               // 38: ExtendBoardPack
	(*ExtendBoard)(nil),                   // 39: ExtendBoard
	(*BoardAttr)(nil),                     // 40: BoardAttr
	(*ExtendBoardGet)(nil),                // 41: ExtendBoardGet
	(*ExtendBoardGetReply)(nil),           // 42: ExtendBoardGetReply
	(*ExtendBoardSet)(nil),                // 43: ExtendBoardSet
	(*ExtendBoardSetReply)(nil),           // 44: ExtendBoardSetReply
	(*ChannelPack)(nil),                   // 45: ChannelPack
	(*SoundConsoleScenePack)(nil),         // 46: SoundConsoleScenePack
	(*RadioFreqPack)(nil),                 // 47: RadioFreqPack
	(*SongPack)(nil),                      // 48: SongPack
	(*SpeechCfg)(nil),                     // 49: SpeechCfg
	(*MiscCfg)(nil),                       // 50: MiscCfg
	(*AlarmIn)(nil),                       // 51: AlarmIn
	(*AlarmOutCfg)(nil),                   // 52: AlarmOutCfg
	(*AlarmOutCfgGet)(nil),                // 53: AlarmOutCfgGet
	(*AlarmOutCfgGetReply)(nil),           // 54: AlarmOutCfgGetReply
	(*AlarmOutCfgSet)(nil),                // 55: AlarmOutCfgSet
	(*AlarmOutCfgSetReply)(nil),           // 56: AlarmOutCfgSetReply
	(*AudioRoute)(nil),                    // 57: AudioRoute
	(*AudioMatrix)(nil),                   // 58: AudioMatrix
	(*AudioMatrixCfgGet)(nil),             // 59: AudioMatrixCfgGet
	(*AudioMatrixCfgGetReply)(nil),        // 60: AudioMatrixCfgGetReply
	(*AudioMatrixCfgSet)(nil),             // 61: AudioMatrixCfgSet
	(*AudioMatrixCfgSetReply)(nil),        // 62: AudioMatrixCfgSetReply
	(*DeviceFeatureList)(nil),             // 63: DeviceFeatureList
	(*SpeakerVolume)(nil),                 // 64: SpeakerVolume
	(*EqCfg)(nil),                         // 65: EqCfg
	(*DeviceInfo)(nil),                    // 66: DeviceInfo
	(*DeviceInfoGet)(nil),                 // 67: DeviceInfoGet
	(*DeviceInfoGetReply)(nil),            // 68: DeviceInfoGetReply
	(*DeviceInfoSet)(nil),                 // 69: DeviceInfoSet
	(*DeviceInfoSetReply)(nil),            // 70: DeviceInfoSetReply
	(*IntelligentizeTask)(nil),            // 71: IntelligentizeTask
	(*Task)(nil),                          // 72: Task
	(*TaskStart)(nil),                     // 73: TaskStart
	(*TaskStartReply)(nil),                // 74: TaskStartReply
	(*TaskStop)(nil),                      // 75: TaskStop
	(*TaskStopReply)(nil),                 // 76: TaskStopReply
	(*TaskGet)(nil),                       // 77: TaskGet
	(*TaskGetReply)(nil),                  // 78: TaskGetReply
	(*TaskAdd)(nil),                       // 79: TaskAdd
	(*TaskAddReply)(nil),                  // 80: TaskAddReply
	(*TaskEdit)(nil),                      // 81: TaskEdit
	(*TaskEditReply)(nil),                 // 82: TaskEditReply
	(*TaskDelete)(nil),                    // 83: TaskDelete
	(*TaskDeleteReply)(nil),               // 84: TaskDeleteReply
	(*TaskIgnore)(nil),                    // 85: TaskIgnore
	(*TaskIgnoreReply)(nil),               // 86: TaskIgnoreReply
	(*TaskIgnoreDateGet)(nil),             // 87: TaskIgnoreDateGet
	(*TaskIgnoreDateGetReply)(nil),        // 88: TaskIgnoreDateGetReply
	(*GetLog)(nil),                        // 89: GetLog
	(*Log)(nil),                           // 90: Log
	(*GetLogReply)(nil),                   // 91: GetLogReply
	(*SongGet)(nil),                       // 92: SongGet
	(*Song)(nil),                          // 93: Song
	(*SongGetReply)(nil),                  // 94: SongGetReply
	(*FileUpload)(nil),                    // 95: FileUpload
	(*FileUploadReply)(nil),               // 96: FileUploadReply
	(*SongDelete)(nil),                    // 97: SongDelete
	(*SongDeleteReply)(nil),               // 98: SongDeleteReply
	(*UdiskSongGet)(nil),                  // 99: UdiskSongGet
	(*UdiskSongGetReply)(nil),             // 100: UdiskSongGetReply
	(*PaNotificationTone)(nil),            // 101: PaNotificationTone
	(*ChannelAttr)(nil),                   // 102: ChannelAttr
	(*OutChannelGet)(nil),                 // 103: OutChannelGet
	(*OutChannelGetReply)(nil),            // 104: OutChannelGetReply
	(*OutChannelEdit)(nil),                // 105: OutChannelEdit
	(*OutChannelEditReply)(nil),           // 106: OutChannelEditReply
	(*InChannelGet)(nil),                  // 107: InChannelGet
	(*InChannelGetReply)(nil),             // 108: InChannelGetReply
	(*InChannelEdit)(nil),                 // 109: InChannelEdit
	(*InChannelEditReply)(nil),            // 110: InChannelEditReply
	(*SoundConsoleTaskControl)(nil),       // 111: SoundConsoleTaskControl
	(*SoundConsoleTaskControlReply)(nil),  // 112: SoundConsoleTaskControlReply
	(*SoundConsoleTaskFeedback)(nil),      // 113: SoundConsoleTaskFeedback
	(*SoundConsoleVolume)(nil),            // 114: SoundConsoleVolume
	(*SoundConsoleScene)(nil),             // 115: SoundConsoleScene
	(*RadioFreq)(nil),                     // 116: RadioFreq
	(*RadioFreqGet)(nil),                  // 117: RadioFreqGet
	(*RadioFreqGetReply)(nil),             // 118: RadioFreqGetReply
	(*RadioFreqAdd)(nil),                  // 119: RadioFreqAdd
	(*RadioFreqAddReply)(nil),             // 120: RadioFreqAddReply
	(*RadioFreqSet)(nil),                  // 121: RadioFreqSet
	(*RadioFreqSetReply)(nil),             // 122: RadioFreqSetReply
	(*RadioFreqDelete)(nil),               // 123: RadioFreqDelete
	(*RadioFreqDeleteReply)(nil),          // 124: RadioFreqDeleteReply
	(*DeviceRestore)(nil),                 // 125: DeviceRestore
	(*DeviceRestoreReply)(nil),            // 126: DeviceRestoreReply
	(*DeviceUpgrade)(nil),                 // 127: DeviceUpgrade
	(*DeviceUpgradeReply)(nil),            // 128: DeviceUpgradeReply
	(*DevicePowerSet)(nil),                // 129: DevicePowerSet
	(*DevicePowerSetReply)(nil),           // 130: DevicePowerSetReply
	(*DevicePowerGet)(nil),                // 131: DevicePowerGet
	(*DevicePowerGetReply)(nil),           // 132: DevicePowerGetReply
	(*DevicePowerPack)(nil),               // 133: DevicePowerPack
	(*TaskSync)(nil),                      // 134: TaskSync
	(*TaskSyncReply)(nil),                 // 135: TaskSyncReply
	(*TaskSyncStatusGet)(nil),             // 136: TaskSyncStatusGet
	(*TaskSyncStatusGetReply)(nil),        // 137: TaskSyncStatusGetReply
	(*TaskStatGet)(nil),                   // 138: TaskStatGet
	(*TaskStatGetReply)(nil),              // 139: TaskStatGetReply
	(*SubscribePublish)(nil),              // 140: SubscribePublish
	(*SubscribePublishReply)(nil),         // 141: SubscribePublishReply
	(*Identity)(nil),                      // 142: Identity
	(*TaskAddOutChannel)(nil),             // 143: TaskAddOutChannel
	(*TaskAddOutChannelReply)(nil),        // 144: TaskAddOutChannelReply
	(*TaskDeleteOutChannel)(nil),          // 145: TaskDeleteOutChannel
	(*TaskDeleteOutChannelReply)(nil),     // 146: TaskDeleteOutChannelReply
	(*SongDownload)(nil),                  // 147: SongDownload
	(*SongDownloadReply)(nil),             // 148: SongDownloadReply
	(*SongDownloadStatus)(nil),            // 149: SongDownloadStatus
	(*SongDownloadComplete)(nil),          // 150: SongDownloadComplete
	(*StereoCfgSet)(nil),                  // 151: StereoCfgSet
	(*StereoCfgSetReply)(nil),             // 152: StereoCfgSetReply
	(*LedCfgSet)(nil),                     // 153: LedCfgSet
	(*LedCfgSetReply)(nil),                // 154: LedCfgSetReply
	(*WirelessCfgSet)(nil),                // 155: WirelessCfgSet
	(*WirelessCfgSetReply)(nil),           // 156: WirelessCfgSetReply
	(*AmpCheckCfgSet)(nil),                // 157: AmpCheckCfgSet
	(*AmpCheckCfgSetReply)(nil),           // 158: AmpCheckCfgSetReply
	(*MiscCfgGet)(nil),                    // 159: MiscCfgGet
	(*MiscCfgGetReply)(nil),               // 160: MiscCfgGetReply
	(*SpeechCfgGet)(nil),                  // 161: SpeechCfgGet
	(*SpeechCfgGetReply)(nil),             // 162: SpeechCfgGetReply
	(*SpeechCfgSet)(nil),                  // 163: SpeechCfgSet
	(*SpeechCfgSetReply)(nil),             // 164: SpeechCfgSetReply
	(*DeviceAliaseSet)(nil),               // 165: DeviceAliaseSet
	(*DeviceAliaseSetReply)(nil),          // 166: DeviceAliaseSetReply
	(*BluetoothWhitelistPack)(nil),        // 167: BluetoothWhitelistPack
	(*BluetoothWhitelist)(nil),            // 168: BluetoothWhitelist
	(*BluetoothWhitelistGet)(nil),         // 169: BluetoothWhitelistGet
	(*BluetoothWhitelistGetReply)(nil),    // 170: BluetoothWhitelistGetReply
	(*BluetoothWhitelistDelete)(nil),      // 171: BluetoothWhitelistDelete
	(*BluetoothWhitelistDeleteReply)(nil), // 172: BluetoothWhitelistDeleteReply
	(*BluetoothWhitelistAdd)(nil),         // 173: BluetoothWhitelistAdd
	(*BluetoothWhitelistAddReply)(nil),    // 174: BluetoothWhitelistAddReply
	(*BluetoothCfg)(nil),                  // 175: BluetoothCfg
	(*BluetoothCfgSet)(nil),               // 176: BluetoothCfgSet
	(*BluetoothCfgSetReply)(nil),          // 177: BluetoothCfgSetReply
	(*BluetoothCfgGet)(nil),               // 178: BluetoothCfgGet
	(*BluetoothCfgGetReply)(nil),          // 179: BluetoothCfgGetReply
	(*PresetAttr)(nil),                    // 180: PresetAttr
	(*PresetPack)(nil),                    // 181: PresetPack
	(*TransferServer)(nil),                // 182: TransferServer
	(*TenantInfo)(nil),                    // 183: TenantInfo
	(*ConsoleAttr)(nil),                   // 184: ConsoleAttr
	(*ConsolePack)(nil),                   // 185: ConsolePack
	(*ConsoleInfo)(nil),                   // 186: ConsoleInfo
	(*TaskPresetSwitch)(nil),              // 187: TaskPresetSwitch
	(*TaskPresetSwitchReply)(nil),         // 188: TaskPresetSwitchReply
	(*TransferServerSet)(nil),             // 189: TransferServerSet
	(*TransferServerSetReply)(nil),        // 190: TransferServerSetReply
	(*AppLogin)(nil),                      // 191: AppLogin
	(*DeviceLogin)(nil),                   // 192: DeviceLogin
	(*DeviceInfoUpdate)(nil),              // 193: DeviceInfoUpdate
	(*DeviceReboot)(nil),                  // 194: DeviceReboot
	(*DeviceRebootReply)(nil),             // 195: DeviceRebootReply
	(*KeyPress)(nil),                      // 196: KeyPress
	(*WriteSn)(nil),                       // 197: WriteSn
	(*WriteSnReply)(nil),                  // 198: WriteSnReply
	(*LedBoardControl)(nil),               // 199: LedBoardControl
	(*LedBoardControlReply)(nil),          // 200: LedBoardControlReply
	(*AppIdBond)(nil),                     // 201: AppIdBond
	(*AppIdBondReply)(nil),                // 202: AppIdBondReply
	(*DeviceTimeGetReply)(nil),            // 203: DeviceTimeGetReply
	(*JoinTenant)(nil),                    // 204: JoinTenant
	(*JoinTenantReply)(nil),               // 205: JoinTenantReply
	(*DebugConnectionCfgSet)(nil),         // 206: DebugConnectionCfgSet
	(*DebugConnectionCfgSetReply)(nil),    // 207: DebugConnectionCfgSetReply
	(*SpeakerVolumeSet)(nil),              // 208: SpeakerVolumeSet
	(*SpeakerVolumeSetReply)(nil),         // 209: SpeakerVolumeSetReply
	(*SpeakerVolumeGetReply)(nil),         // 210: SpeakerVolumeGetReply
	(*EqCfgSet)(nil),                      // 211: EqCfgSet
	(*EqCfgSetReply)(nil),                 // 212: EqCfgSetReply
	(*UChannelSet)(nil),                   // 213: UChannelSet
	(*UChannelSetReply)(nil),              // 214: UChannelSetReply
	(*HowlingSuppressionSet)(nil),         // 215: HowlingSuppressionSet
	(*HowlingSuppressionSetReply)(nil),    // 216: HowlingSuppressionSetReply
	(*AudioMixSet)(nil),                   // 217: AudioMixSet
	(*AudioMixSetReply)(nil),              // 218: AudioMixSetReply
	(*AudioSuppressionSet)(nil),           // 219: AudioSuppressionSet
	(*AudioSuppressionSetReply)(nil),      // 220: AudioSuppressionSetReply
	(*PaReinitSet)(nil),                   // 221: PaReinitSet
	(*PaReinitSetReply)(nil),              // 222: PaReinitSetReply
	(*LowShelfCfg)(nil),                   // 223: LowShelfCfg
	(*LowShelfSet)(nil),                   // 224: LowShelfSet
	(*LowShelfSetReply)(nil),              // 225: LowShelfSetReply
	(*FirmwareDownloadProgress)(nil),      // 226: FirmwareDownloadProgress
	(*SpeakerChannelStatusGet)(nil),       // 227: SpeakerChannelStatusGet
	(*SpeakerChannelStatusGetReply)(nil),  // 228: SpeakerChannelStatusGetReply
	(*SpeakerChannelStatus)(nil),          // 229: SpeakerChannelStatus
	(*DeviceAdvertiseData)(nil),           // 230: DeviceAdvertiseData
	(*FactoryTest)(nil),                   // 231: FactoryTest
	(*FactoryTestReply)(nil),              // 232: FactoryTestReply
	(*PbMsg)(nil),                         // 233: PbMsg
}
var file_pbmsg_proto_depIdxs = []int32{
	1,   // 0: UserLoginReply.status:type_name -> Status
	1,   // 1: DateSetReply.status:type_name -> Status
	1,   // 2: DateGetReply.status:type_name -> Status
	29,  // 3: NetCfg.ncscfg:type_name -> NcsCfg
	30,  // 4: NetCfg.sipcfg:type_name -> SipCfg
	1,   // 5: NetCfgGetReply.status:type_name -> Status
	31,  // 6: NetCfgGetReply.cfg:type_name -> NetCfg
	31,  // 7: NetCfgSet.cfg:type_name -> NetCfg
	1,   // 8: NetCfgSetReply.status:type_name -> Status
	29,  // 9: NcsCfgSet.cfg:type_name -> NcsCfg
	1,   // 10: NcsCfgSetReply.status:type_name -> Status
	39,  // 11: ExtendBoardPack.extend_board:type_name -> ExtendBoard
	40,  // 12: ExtendBoard.board:type_name -> BoardAttr
	2,   // 13: BoardAttr.type:type_name -> BoardBtnType
	1,   // 14: ExtendBoardGetReply.status:type_name -> Status
	38,  // 15: ExtendBoardGetReply.extend_boards:type_name -> ExtendBoardPack
	38,  // 16: ExtendBoardSet.extend_boards:type_name -> ExtendBoardPack
	1,   // 17: ExtendBoardSetReply.status:type_name -> Status
	102, // 18: ChannelPack.channel:type_name -> ChannelAttr
	115, // 19: SoundConsoleScenePack.scene:type_name -> SoundConsoleScene
	116, // 20: RadioFreqPack.rf:type_name -> RadioFreq
	93,  // 21: SongPack.songs:type_name -> Song
	64,  // 22: MiscCfg.speaker_volume:type_name -> SpeakerVolume
	65,  // 23: MiscCfg.eq_cfg:type_name -> EqCfg
	223, // 24: MiscCfg.low_shelf_cfg:type_name -> LowShelfCfg
	182, // 25: MiscCfg.transfer_server:type_name -> TransferServer
	3,   // 26: AlarmIn.trigger_status:type_name -> AlarmInStatus
	4,   // 27: AlarmIn.trigger_method:type_name -> AlarmInTriggerMethod
	1,   // 28: AlarmOutCfgGetReply.status:type_name -> Status
	52,  // 29: AlarmOutCfgGetReply.cfg:type_name -> AlarmOutCfg
	52,  // 30: AlarmOutCfgSet.cfg:type_name -> AlarmOutCfg
	1,   // 31: AlarmOutCfgSetReply.status:type_name -> Status
	57,  // 32: AudioMatrix.audio_route:type_name -> AudioRoute
	1,   // 33: AudioMatrixCfgGetReply.status:type_name -> Status
	58,  // 34: AudioMatrixCfgGetReply.audio_matrix:type_name -> AudioMatrix
	58,  // 35: AudioMatrixCfgSet.audio_matrix:type_name -> AudioMatrix
	1,   // 36: AudioMatrixCfgSetReply.status:type_name -> Status
	31,  // 37: DeviceInfo.netcfg:type_name -> NetCfg
	45,  // 38: DeviceInfo.in_channel:type_name -> ChannelPack
	45,  // 39: DeviceInfo.out_channel:type_name -> ChannelPack
	47,  // 40: DeviceInfo.radio_freq:type_name -> RadioFreqPack
	133, // 41: DeviceInfo.device_power:type_name -> DevicePowerPack
	50,  // 42: DeviceInfo.misc_cfg:type_name -> MiscCfg
	49,  // 43: DeviceInfo.speech_cfg:type_name -> SpeechCfg
	175, // 44: DeviceInfo.bluetooth_cfg:type_name -> BluetoothCfg
	167, // 45: DeviceInfo.bluetooth_whitelist:type_name -> BluetoothWhitelistPack
	58,  // 46: DeviceInfo.audio_matrix:type_name -> AudioMatrix
	38,  // 47: DeviceInfo.extend_boards:type_name -> ExtendBoardPack
	52,  // 48: DeviceInfo.alarm_out_cfg:type_name -> AlarmOutCfg
	63,  // 49: DeviceInfo.feature_list:type_name -> DeviceFeatureList
	1,   // 50: DeviceInfoGetReply.status:type_name -> Status
	66,  // 51: DeviceInfoGetReply.info:type_name -> DeviceInfo
	66,  // 52: DeviceInfoSet.info:type_name -> DeviceInfo
	1,   // 53: DeviceInfoSetReply.status:type_name -> Status
	8,   // 54: IntelligentizeTask.task_type:type_name -> TaskType
	7,   // 55: Task.source:type_name -> AudioSource
	6,   // 56: Task.repeat:type_name -> RepeatType
	8,   // 57: Task.task_type:type_name -> TaskType
	7,   // 58: Task.background:type_name -> AudioSource
	9,   // 59: Task.text_display_style:type_name -> TEXT_DISPLAY_STYLE
	10,  // 60: Task.text_display_speed:type_name -> TEXT_DISPLAY_SPEED
	51,  // 61: Task.alarm_in:type_name -> AlarmIn
	11,  // 62: Task.song_play_type:type_name -> SongPlayType
	14,  // 63: Task.pa_stream_type:type_name -> PaStreamType
	72,  // 64: TaskStart.task:type_name -> Task
	1,   // 65: TaskStartReply.status:type_name -> Status
	8,   // 66: TaskStop.task_type:type_name -> TaskType
	1,   // 67: TaskStopReply.status:type_name -> Status
	72,  // 68: TaskGetReply.task:type_name -> Task
	72,  // 69: TaskAdd.task:type_name -> Task
	1,   // 70: TaskAddReply.status:type_name -> Status
	72,  // 71: TaskEdit.task:type_name -> Task
	1,   // 72: TaskEditReply.status:type_name -> Status
	1,   // 73: TaskDeleteReply.status:type_name -> Status
	1,   // 74: TaskIgnoreReply.status:type_name -> Status
	1,   // 75: TaskIgnoreDateGetReply.status:type_name -> Status
	12,  // 76: GetLog.type:type_name -> LogType
	1,   // 77: GetLogReply.status:type_name -> Status
	90,  // 78: GetLogReply.log:type_name -> Log
	12,  // 79: GetLogReply.type:type_name -> LogType
	1,   // 80: SongGetReply.status:type_name -> Status
	48,  // 81: SongGetReply.songs:type_name -> SongPack
	13,  // 82: FileUpload.filetype:type_name -> FileType
	1,   // 83: FileUploadReply.status:type_name -> Status
	1,   // 84: SongDeleteReply.status:type_name -> Status
	1,   // 85: UdiskSongGetReply.status:type_name -> Status
	93,  // 86: UdiskSongGetReply.songs:type_name -> Song
	101, // 87: ChannelAttr.pa_notification_tone:type_name -> PaNotificationTone
	14,  // 88: ChannelAttr.pa_stream_type:type_name -> PaStreamType
	102, // 89: OutChannelGetReply.channel:type_name -> ChannelAttr
	102, // 90: OutChannelEdit.attr:type_name -> ChannelAttr
	1,   // 91: OutChannelEditReply.status:type_name -> Status
	102, // 92: InChannelGetReply.channel:type_name -> ChannelAttr
	102, // 93: InChannelEdit.attr:type_name -> ChannelAttr
	1,   // 94: InChannelEditReply.status:type_name -> Status
	16,  // 95: SoundConsoleTaskControl.command:type_name -> SoundConsoleTaskControlCommand
	15,  // 96: SoundConsoleTaskControl.volume_type:type_name -> VolumeType
	1,   // 97: SoundConsoleTaskControlReply.status:type_name -> Status
	114, // 98: SoundConsoleScene.volume:type_name -> SoundConsoleVolume
	1,   // 99: RadioFreqGetReply.status:type_name -> Status
	116, // 100: RadioFreqGetReply.rf:type_name -> RadioFreq
	116, // 101: RadioFreqAdd.rf:type_name -> RadioFreq
	1,   // 102: RadioFreqAddReply.status:type_name -> Status
	116, // 103: RadioFreqSet.rf:type_name -> RadioFreq
	1,   // 104: RadioFreqSetReply.status:type_name -> Status
	116, // 105: RadioFreqDelete.rf:type_name -> RadioFreq
	1,   // 106: RadioFreqDeleteReply.status:type_name -> Status
	1,   // 107: DeviceRestoreReply.status:type_name -> Status
	1,   // 108: DeviceUpgradeReply.status:type_name -> Status
	17,  // 109: DevicePowerSet.out_1_power:type_name -> DevicePower
	17,  // 110: DevicePowerSet.out_2_power:type_name -> DevicePower
	17,  // 111: DevicePowerSet.out_3_power:type_name -> DevicePower
	17,  // 112: DevicePowerSet.out_4_power:type_name -> DevicePower
	1,   // 113: DevicePowerSetReply.status:type_name -> Status
	1,   // 114: DevicePowerGetReply.status:type_name -> Status
	17,  // 115: DevicePowerGetReply.out_1_power:type_name -> DevicePower
	17,  // 116: DevicePowerGetReply.out_2_power:type_name -> DevicePower
	17,  // 117: DevicePowerGetReply.out_3_power:type_name -> DevicePower
	17,  // 118: DevicePowerGetReply.out_4_power:type_name -> DevicePower
	17,  // 119: DevicePowerPack.out_1_power:type_name -> DevicePower
	17,  // 120: DevicePowerPack.out_2_power:type_name -> DevicePower
	17,  // 121: DevicePowerPack.out_3_power:type_name -> DevicePower
	17,  // 122: DevicePowerPack.out_4_power:type_name -> DevicePower
	18,  // 123: TaskSync.type:type_name -> TaskSyncType
	1,   // 124: TaskSyncReply.status:type_name -> Status
	19,  // 125: TaskSyncStatusGetReply.status:type_name -> TaskSyncStatus
	1,   // 126: TaskStatGetReply.status:type_name -> Status
	1,   // 127: SubscribePublishReply.status:type_name -> Status
	1,   // 128: TaskAddOutChannelReply.status:type_name -> Status
	1,   // 129: TaskDeleteOutChannelReply.status:type_name -> Status
	1,   // 130: SongDownloadReply.status:type_name -> Status
	1,   // 131: SongDownloadStatus.status:type_name -> Status
	1,   // 132: StereoCfgSetReply.status:type_name -> Status
	1,   // 133: LedCfgSetReply.status:type_name -> Status
	1,   // 134: WirelessCfgSetReply.status:type_name -> Status
	1,   // 135: AmpCheckCfgSetReply.status:type_name -> Status
	1,   // 136: MiscCfgGetReply.status:type_name -> Status
	50,  // 137: MiscCfgGetReply.misc_cfg:type_name -> MiscCfg
	1,   // 138: SpeechCfgGetReply.status:type_name -> Status
	49,  // 139: SpeechCfgGetReply.speech_cfg:type_name -> SpeechCfg
	49,  // 140: SpeechCfgSet.speech_cfg:type_name -> SpeechCfg
	1,   // 141: SpeechCfgSetReply.status:type_name -> Status
	1,   // 142: DeviceAliaseSetReply.status:type_name -> Status
	168, // 143: BluetoothWhitelistPack.whitelist:type_name -> BluetoothWhitelist
	1,   // 144: BluetoothWhitelistGetReply.status:type_name -> Status
	168, // 145: BluetoothWhitelistGetReply.whitelist:type_name -> BluetoothWhitelist
	168, // 146: BluetoothWhitelistDelete.whitelist:type_name -> BluetoothWhitelist
	1,   // 147: BluetoothWhitelistDeleteReply.status:type_name -> Status
	168, // 148: BluetoothWhitelistAdd.whitelist:type_name -> BluetoothWhitelist
	1,   // 149: BluetoothWhitelistAddReply.status:type_name -> Status
	175, // 150: BluetoothCfgSet.bluetooth_cfg:type_name -> BluetoothCfg
	1,   // 151: BluetoothCfgSetReply.status:type_name -> Status
	1,   // 152: BluetoothCfgGetReply.status:type_name -> Status
	175, // 153: BluetoothCfgGetReply.bluetooth_cfg:type_name -> BluetoothCfg
	180, // 154: PresetPack.preset:type_name -> PresetAttr
	181, // 155: TenantInfo.presetpack:type_name -> PresetPack
	184, // 156: ConsolePack.console:type_name -> ConsoleAttr
	185, // 157: ConsoleInfo.consolepack:type_name -> ConsolePack
	1,   // 158: TaskPresetSwitchReply.status:type_name -> Status
	182, // 159: TransferServerSet.transfer_server:type_name -> TransferServer
	1,   // 160: TransferServerSetReply.status:type_name -> Status
	66,  // 161: DeviceInfoUpdate.info:type_name -> DeviceInfo
	1,   // 162: DeviceRebootReply.status:type_name -> Status
	20,  // 163: KeyPress.id:type_name -> Key
	1,   // 164: WriteSnReply.status:type_name -> Status
	21,  // 165: LedBoardControl.id:type_name -> LedBoardControlId
	1,   // 166: LedBoardControlReply.status:type_name -> Status
	1,   // 167: AppIdBondReply.status:type_name -> Status
	1,   // 168: JoinTenantReply.status:type_name -> Status
	1,   // 169: DebugConnectionCfgSetReply.status:type_name -> Status
	64,  // 170: SpeakerVolumeSet.volume:type_name -> SpeakerVolume
	1,   // 171: SpeakerVolumeSetReply.status:type_name -> Status
	64,  // 172: SpeakerVolumeGetReply.volume:type_name -> SpeakerVolume
	65,  // 173: EqCfgSet.eq_cfg:type_name -> EqCfg
	1,   // 174: EqCfgSetReply.status:type_name -> Status
	1,   // 175: UChannelSetReply.status:type_name -> Status
	1,   // 176: HowlingSuppressionSetReply.status:type_name -> Status
	1,   // 177: AudioMixSetReply.status:type_name -> Status
	1,   // 178: AudioSuppressionSetReply.status:type_name -> Status
	1,   // 179: PaReinitSetReply.status:type_name -> Status
	223, // 180: LowShelfSet.cfg:type_name -> LowShelfCfg
	1,   // 181: LowShelfSetReply.status:type_name -> Status
	1,   // 182: SpeakerChannelStatusGetReply.status:type_name -> Status
	31,  // 183: DeviceAdvertiseData.netcfg:type_name -> NetCfg
	22,  // 184: FactoryTest.id:type_name -> FactoryTestId
	9,   // 185: FactoryTest.text_display_style:type_name -> TEXT_DISPLAY_STYLE
	10,  // 186: FactoryTest.text_display_speed:type_name -> TEXT_DISPLAY_SPEED
	1,   // 187: FactoryTestReply.status:type_name -> Status
	0,   // 188: PbMsg.id:type_name -> MsgId
